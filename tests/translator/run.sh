...
# checked laws), the four defs and the module each with --optimize: optimize.bend's file is the faithful one byte
# for byte, or (repo_of) judged again, C1-C4.
...
for demo in normalize_stem repo_of first_dash fm_sources source_stems; do
