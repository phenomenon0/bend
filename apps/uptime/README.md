...
| 50 monitors at 1 s, 240 s | 12,050 probes of 12,001; CPU 1.2% of a core | 6,797 in 120 s (it kept probing after SIGTERM, fixed since); CPU 10.7% |
...
| restart with the log | 12.6 MB, 113,688 lines: 13.5 s before the fix below; 100,000 lines: 19.1 s, then 3.9 s (the `Bool.pick` form now builds as fast: FRICTION.md 1) | 7,475 lines: 24.8 s |
| SIGTERM | exit 0 in 0.27 s | exit 0 in 0.36 s (ignored before ce884a5d: FRICTION.md) |
